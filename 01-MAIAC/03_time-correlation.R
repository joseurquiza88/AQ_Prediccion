...
buffer_time <- 90 #minutes
buffer_spatial <- "15km"
city <- "MX"
num_site <- "6"
# BA
formato_fecha <- "%d/%m/%Y %H:%M"
data_maiac <- paste("D:/Josefina/paper_git/paper_maiac/datasets/V03/maiac/Latam_C61/",city,"/prueba_",buffer_spatial,"_",city,"_C61_tot_V03.csv",sep="")
...
write.csv (combinate_BA,paste("D:/Josefina/paper_git/paper_maiac/datasets/V03/processed/merge_AER-MAIAC/Latam_C61/tot/",buffer_spatial,"/",num_site,"_",city,"-",buffer_spatial,"-MAIAC-",buffer_time,"-AER_C61.csv",sep=""))
###############################################################################
###############################################################################
###############################################################################
# PROMEDIOS DIARIOS
...
num_estacion <- 3
# BA
combinate <- read.csv(paste("D:/Josefina/paper_git/paper_maiac/datasets/V03/processed/merge_AER-MAIAC/Latam_C61/tot/",buffer_spatial,"/",num_estacion ,"_",city ,"-",buffer_spatial ,"-MAIAC-",buffer_time ,"-AER_C61.csv",sep=""))
combinate_promedios <- promedios(combinate)
write.csv(combinate_promedios,paste("D:/Josefina/paper_git/paper_maiac/datasets/V03/processed/merge_AER-MAIAC/Latam_C61/dia/",buffer_spatial,"/",num_estacion,"_",city,"-",buffer_spatial,"-MAIAC-",buffer_time,"-AER_MEAN_C61.csv",sep=""))
